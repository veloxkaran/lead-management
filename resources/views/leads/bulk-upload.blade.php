...
@section('content')
    <x-page-header title="Bulk Upload Leads" icon="bi-upload" subtitle="Import multiple leads at once from a spreadsheet. Only basic details are imported — everything else (assignment, status, financials) can be filled in afterward." />
    ...
    <div class="row g-3">
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <a href="{{ route('leads.bulk-upload.template') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="col-lg-6">
            ...
            @else
                <x-empty-state icon="bi-upload" title="No results yet" description="Upload a file to see how many leads were imported." />
            @endif
        </div>
    </div>
@endsection
